...
public class LoginTests {
    ...
    public void LoginUserTest(String data) {
        ...
        Response response1 = LoginUserUtils.loginNewUser(Username, Userpassword,200);
        System.out.println("Response JSON Body2: " + response1.getBody().asString());//print response body
        softAssert.assertEquals(jsonPath.getString("message").startsWith("logged in user session:"), true);
